...
const publications = [
    ...
    .withName("Licuadora Oster Brly07-z00-354")
    .withValue(2.599)
    .withImage(new PublicationImage("", "https://http2.mlstatic.com/licuadora-oster-brly07-z00-354-15-lts-3-velocidades-600-w-D_NQ_NP_791678-MLA31116034201_062019-O.webp", ""))
    ,
    new PublicationBuilder()
    .withName("Tv Led 32 Philips Hd Mod. 32phg5101/77")
    .withValue(6.199)
    .withImage(new PublicationImage("", "https://http2.mlstatic.com/tv-led-32-philips-hd-mod-32phg510177-D_NQ_NP_606672-MLA31061756040_062019-O.webp", ""))
    ,
    new PublicationBuilder()
    .withName("Heladera Ciclica Gafa Hgf-357aw 281lt")
    .withValue(13.999)
    .withImage(new PublicationImage("", "https://http2.mlstatic.com/heladera-ciclica-patrick-hpk135b01-277lt-D_NQ_NP_848604-MLA31013391123_062019-O.webp", ""))
]
...
const publicationTableInsert =
    `CREATE TABLE ${Publication.tableName} (
        id serial PRIMARY KEY,
        name text,
        value text,
...
const publicationImageTableInsert =
    `CREATE TABLE ${PublicationImage.tableName}(
        id serial PRIMARY KEY,
        image text,
...
const tables = [
    ...
    answerTableInsert,
    questionTableInsert,
    publicationImageTableInsert,
    cartTableInsert,
    publicationTableInsert,
    productTableInsert,
    clientTableInsert,
    adminTableInsert,
    roleTableInsert,
